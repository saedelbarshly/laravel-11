...
<body>  
<div class="container">
    <h3 style="margin-top: 30px;">Laravel 11 Mobile Number (OTP) Authentication using Firebase - websolutionstuff.com</h3><br>  
    ...
    <div class="card">
      ...
      <div class="card-body">  
        ...
        <form>
            ...
            <input type="text" id="number" class="form-control" placeholder="012346789"><br>
...
<script type="text/javascript">
    ...
    function SendCode() {
        ...
        let number = $("#number").val().replace(/^0/, '+20');
        ...
        firebase.auth().signInWithPhoneNumber(number,window.recaptchaVerifier).then(function (confirmationResult) {
            ...
            window.location.href = '/test-verify-otp';
